...
Geräte sind pro Firmware-Version letzte Woche offline gegangen" erforderte
...
visualisieren, via ArgoCD deployen.
...
3. **dbt**: transformiert rohes JSONB in typisierte, indizierte Tabellen.
   Staging-Modelle flachen ab und deduplizieren, Mart-Modelle joinen und
   indizieren für Query-Performance.
...
**Staging**-Modelle flachen ab und deduplizieren. Das wichtigste,
...
merge auf main und genehmige den Sync manuell in der ArgoCD-UI.

## Source Freshness

dbts Source-Freshness-Checks sind in die Pipeline integriert. Jede Quelle hat
